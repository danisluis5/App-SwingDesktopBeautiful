...
public class ControllerTang extends AbstractTableModel{
    ...
    public int deleteItem(Floor obj, int row) {
        // xóa trong database
        int result = model.delItem(obj.getMaT());
        // xóa trong model
    ...
    public void loadCategory(JComboBox<Floor> cbDanhMuc, boolean isSearch, Floor obj) {
